...
void renderScene() {
    ...
    //chair leg 2
    float table_bottom_l[2] = { table_top_size + leg_width, 0 };
    float chair_bl[2] = { table_bottom_l[0] + 2*chair_distance, 0 };
    glColor3f(0, 0, 1);//blue
    glRectf(chair_bl[0], 0, chair_bl[0] + leg_width, 5*l);
    //chair seat
    float table_bottom_m[2] = { table_top_size + leg_width, 0 };
    float chair_m[2] = { table_bottom_m[0] + chair_distance, 0 };
    glColor3f(0, 0, 1);//blue
    glRectf(chair_m[0], l, chair_m[0] + chair_distance, l/2);
    glFlush();
}
